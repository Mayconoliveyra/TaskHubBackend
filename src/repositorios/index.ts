...
import * as configModulo from './configModulo';
...
export const Repositorios = { ...usuario, ...empresa, ...produtosMC, ...produtosERP, ...tarefa, ...tarefaEmpresa, ...nfse, ...bancoImagens, ...configModulo };
